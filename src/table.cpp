...
uint64_t
tableC<encT>::fillVec(const char* filepath, unsigned int batch_size)
{
...
template uint64_t
tableC<uint32_t>::fillVec(const char* filepath, unsigned int batch_size);

template uint64_t
tableC<uint64_t>::fillVec(const char* filepath, unsigned int batch_size);
